...
if position == "F":  # Forwards
    params = [
        "Goals per 90", "Expected Goals per 90", "Shots per 90", "Assists per 90", 
        "Key Passes per 90", "Big Chances Created per 90", "Dribbles per 90", 
        "Aerial Duel Win %", "Goal Conversion %"
    ]
    raw_stats = [
        "goals_per_90", "xg_per_90", "shots_per_90", "assists_per_90",
        "keypasses_per_90", "bigchancescreated_per_90", "dribbles_per_90",
        "aerialduelswonpercentage", "goalconversionpercentage"
    ]
